...
\begin{figure}[H]
\centerline{\includegraphics[scale=0.7]{relabel_1.png}}
\label{fig:program_expl}
\end{figure}

\begin{figure}[H]
\centerline{\includegraphics[scale=0.7]{relabel_2.png}}
...
\begin{figure}[H]
\centerline{\includegraphics[scale=0.75]{bisimall.png}}
\end{figure}
